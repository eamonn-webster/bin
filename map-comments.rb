...
#
=begin
This script remaps issue ids. When I started using issue ids I started at 5000 because I wanted to leave room so that at some stage in the future I could assign ids to the previous issues. As it turns out 1000 would have been enough.
Well the time has come. The idea is that I will use git's filter-branch command to rewrite history. I need to process files and commit messages. In each case I need to subtract 4000 from each issue number greater than 5000. This is easy enough as I haven't yet reached 6000.
